...
<html lang="en">
  ...
  <head>
    ...
    <title>RMC - Imobiliaria teste3</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-8">
          <ul class="info">
            <li><i class="fa fa-envelope"></i> rmcimobiliaria@gmail.com</li>
            <li><i class="fa fa-map"></i> Av. 15 de Junho, QD 03 - LOTE 26 - VALPARAISO II, 72870-103</li>
          </ul>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image">
            <img src="{{asset('images/featured.jpg')}}" alt="">
            <a href="property-details.html"><img src="{{asset('images/featured-icon.png')}}" alt="" style="max-width: 60px; padding: 0px;"></a>
          </div>
        </div>
        <div class="col-lg-5">
  ...
  <div class="properties section">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="{{asset('images/property-02.jpg')}}" alt=""></a>
            <span class="category">Luxury Villa</span>
            <h6>$1.180.000</h6>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="{{asset('images/property-03.jpg')}}" alt=""></a>
            <span class="category">Luxury Villa</span>
            <h6>$1.460.000</h6>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="{{asset('images/property-04.jpg')}}" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="{{asset('images/property-05.jpg')}}" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="{{asset('images/property-06.jpg')}}" alt=""></a>
